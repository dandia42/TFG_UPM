...
/* Win32 has an annoying issue where there are multiple C run-time
   ...
   exitgl routine).  GLUT is typically built with the
   ...
   the executable's "exitgl" function pointer is covertly passed to GLUT.
   GLUT then calls the executable's exitgl function pointer to ensure that
...
extern _CRTIMP void __cdecl exitgl(int);
#endif
#else
/* non-Win32 case. */
...
#define GLUTAPI extern
#define GLUTCALLBACK
/* Prototype exitgl for the non-Win32 case (see above). */
// extern void exitgl(int);
#endif
...
/* GLUT initialization sub-API. */ /*
 ...
 #ifndef GLUT_BUILDING_LIB
     static void APIENTRY glutInit_ATEXIT_HACK(int* argcp, char** argv) { __glutInitWithExit(argcp, argv, exitgl); }
...
#ifndef GLUT_BUILDING_LIB
 static int APIENTRY glutCreateWindow_ATEXIT_HACK(const char* title) { return __glutCreateWindowWithExit(title, exitgl);
} #define glutCreateWindow glutCreateWindow_ATEXIT_HACK #endif #endif*/
...
#ifndef GLUT_BUILDING_LIB
 static int APIENTRY glutCreateMenu_ATEXIT_HACK(void (GLUTCALLBACK* func)(int)) { return __glutCreateMenuWithExit(func,
exitgl); } #define glutCreateMenu glutCreateMenu_ATEXIT_HACK #endif #endif*/
